...
const Docs: FC = () => {
  return (
    ...
    <div className={styles.container}>
      ...
      <p>POST https://4cyoyyncj52fpfbyuoc2ajxzou0hpgkf.lambda-url.eu-north-1.on.aws/</p>
  ...
  https://https://4cyoyyncj52fpfbyuoc2ajxzou0hpgkf.lambda-url.eu-north-1.on.aws/</p>
    </div>
    </div>
    </Layout>
  );
